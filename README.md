# 🎮 Game - Projeto Jogo em Python (POO)
...
Este projeto é um jogo desenvolvido em Python que aplica conceitos fundamentais de **Programação Orientada a Objetos** (POO), como:
- Classes e Objetos
- Herança
- Encapsulamento
- Polimorfismo
...
git clone git@github.com:AugustoFFG/Game.git
